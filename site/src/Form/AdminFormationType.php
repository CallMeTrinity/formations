 ...
 * La visibilité et les tags se règlent à part, en accès rapide (turbo frames).
 */
class AdminFormationType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            // Les tags ne sont pas gérés ici : ils ont leur propre turbo frame
            // (sélection enregistrée immédiatement), cf. TagAdminController.
        ;
    }
